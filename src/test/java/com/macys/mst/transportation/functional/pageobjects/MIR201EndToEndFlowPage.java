...
public class MIR201EndToEndFlowPage extends BasePage {
	StepsDataStore dataStorage = StepsDataStore.getInstance();

	private static Logger log = Logger.getLogger(MIR201EndToEndFlowPage.class.getName());
	...
	public void POCreation() throws InterruptedException {
